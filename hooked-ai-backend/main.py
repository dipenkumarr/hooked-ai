...
import numpy as np
from cohere.types import UserMessage
...
def create_subtitles_with_ffmpeg(
    ...
    for segment in clip_segments:
        word = segment.get("text", "").strip()  # Fix: use "text" instead of "word"
    ...
    subs.info["WrapStyle"] = "0"  # Fix: use string instead of int
    subs.info["ScaledBorderAndShadow"] = "yes"
    subs.info["PlayResX"] = "1080"  # Fix: use string instead of int
    subs.info["PlayResY"] = "1920"  # Fix: use string instead of int
    ...
    new_style.outlinecolor = pysubs2.Color(0, 0, 0, 128)
...
def process_clip(
    ...
    s3_client.upload_file(subtitle_output_path, "hooked-ai", output_s3_key)
...
class HookedAI:
    ...
    def load_model(self):
        ...
        self.cohere_client = cohere.ClientV2(api_key=os.environ["COHERE_API_KEY"])
