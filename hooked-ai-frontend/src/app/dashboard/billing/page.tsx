...
const plans: PricingPlan[] = [
    {
        ...
        features: ["50 credits", "No expiration", "Downloadable Clips"],
        buttonText: "Buy Small Pack",
    ...
    },
    {
        title: "Medium",
        price: "$24.99",
        description: "Best value for regular projects.",
        features: ["150 credits", "No expiration", "Downloadable Clips"],
        buttonText: "Buy Medium Pack",
    ...
    },
    {
        title: "Large",
        price: "$69.99",
        description: "Best for large projects and studios.",
        features: ["500 credits", "No expiration", "Downloadable Clips"],
        buttonText: "Buy Large Pack",
        ...
        <div className="mx-auto flex flex-col space-y-8 px-4 py-12">
            <div className="flex relative justify-center items-center gap-4">
                ...
                <div className="space-y-2 text-center">
                    <h1 className="text-2xl font-semibold tracking-tight sm:text-4xl">Buy Credits</h1>
                    <p className="text-muted-foreground">Purchase credits to generate more clips.</p>
                </div>
            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-6">
                ...
                <ul className="text-black/60 list-disc space-y-2 pl-5 text-sm">
